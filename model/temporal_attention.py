...
"""
给定节点自己、它的邻居和边的时间戳，返回节点的 temporal embedding。
"""
class TemporalAttentionLayer(torch.nn.Module):
  ...
  def __init__(self, n_node_features, n_neighbors_features, n_edge_features, time_dim,
    ...
    self.feat_dim = n_node_features  # 节点特征维度
    self.time_dim = time_dim  # 节点特征维度

    self.query_dim = n_node_features + time_dim  # Query 由当前节点自己的特征,当前节点的时间特征组成
